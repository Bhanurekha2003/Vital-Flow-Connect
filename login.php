...
<body background="https://www.mdanderson.org/images/publications/cancerwise/B/CW_Blood_Cells_WEB.jpg">
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:350px; background-image:url('https://img.freepik.com/free-photo/abstract-luxury-plain-blur-grey-black-gradient-used-as-background-studio-wall-display-your-products_1258-63617.jpg');">
          <div class="card-body">
  ...
  <div class="row justify-content-lg-center justify-content-mb-center">
    ...
    <div><input type="submit" name="login" class="btn btn-primary" value="LOGIN" style="cursor:pointer"></div><br>
    <p >Donor Login ?  <a href="donor.php">Login</p></a>
    <p >Patient Login ?  <a href="request.php">Login</p></a>
    </div>
  </div>
    </div>
