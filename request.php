...
<body background="https://www.mdanderson.org/images/publications/cancerwise/B/CW_Blood_Cells_WEB.jpg">
  ...
  <div class="row justify-content-lg-center justify-content-mb-center">
    ...
    <div><input type="submit" name="request" class="btn btn-primary" value="LOGIN" style="cursor:pointer"></div><br>
    <p>Not a Member ? <a href="register2.php">Register</a>
    </div>
  </div>
    </div>
  </div></div>
<br>
  ...
  if(isset($_POST["request"])){
    ...
    $sql="SELECT * from request_info where username='$username' and password='$password'";
