...
<div id="sidebar1">
<?php $active="list"; include 'sidebar1.php'; ?>
...
<div class="table-responsive"style="text-align:center;align:center">
    ...
    if(mysqli_num_rows($result1) > 0){
      ...
      if($page > 1){
        echo '<li><a href="details.php?page='.($page - 1).'">Prev</a></li>';
      }
      for($i = 1; $i <= $total_page; $i++){
        ...
        echo '<li class="'.$active.'"><a href="details.php?page='.$i.'">'.$i.'</a></li>';
      }
      if($total_page > $page){
        echo '<li><a href="details.php?page='.($page + 1).'">Next</a></li>';
      }
